                ...
                <div className='xola-content'>
                    <div className='profile-section'>
                        <div className={`image-wrapper ${imageLoaded ? 'loaded' : ''}`}>
                            <img
                                src={Opa}
                                alt="Miradilova Nasiba Kadirovna - O'zbekiston ayollar va qizlar uyushmasi Raisi"
                                onLoad={() => setImageLoaded(true)}
                            />
                            <div className='image-overlay'>
                                <div className='overlay-text'>Rais</div>
                            </div>
                    ...
                    <div className='info-section'>
                        <div className='header-content'>
                            ...
                            <h1 className='name-title'>
                                <span className='first-name'>Miradilova</span>
                                <span className='last-name'>Nasiba Kadirovna</span>
                            </h1>

                            <div className='position'>
                                <span className='position-icon'>💼</span>
                                <span>O'zbekiston ayollar va qizlar uyushmasi Raisi</span>
                            </div>

                            <p className='bio'>
                                Uzoq yillik tajribaga ega rahbar sifatida ayollar huquqlari himoyasi,
                                ijtimoiy-iqtisodiy taraqqiyot va gender tengligi sohalarida faol ishtirok etmoqda.
                            </p>
                        </div>

                        <div className='contact-section'>
                            <h3 className='contact-title'>Bog'lanish uchun:</h3>
